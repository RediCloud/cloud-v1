...
package net.suqatri.redicloud.limbo.connection;

import io.netty.buffer.Unpooled;
import net.suqatri.redicloud.limbo.LimboConstants;
import net.suqatri.redicloud.limbo.protocol.packets.PacketHandshake;
import net.suqatri.redicloud.limbo.protocol.packets.login.PacketLoginPluginRequest;
import net.suqatri.redicloud.limbo.protocol.packets.login.PacketLoginPluginResponse;
import net.suqatri.redicloud.limbo.protocol.packets.login.PacketLoginStart;
import net.suqatri.redicloud.limbo.protocol.packets.status.PacketStatusPing;
import net.suqatri.redicloud.limbo.protocol.packets.status.PacketStatusRequest;
import net.suqatri.redicloud.limbo.protocol.packets.status.PacketStatusResponse;
import net.suqatri.redicloud.limbo.server.LimboServer;
import net.suqatri.redicloud.limbo.server.Logger;
import net.suqatri.redicloud.limbo.util.UuidUtil;
