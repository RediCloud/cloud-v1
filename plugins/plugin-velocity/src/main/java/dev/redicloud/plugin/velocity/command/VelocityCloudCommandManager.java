...
import dev.redicloud.commands.Locales;
import dev.redicloud.commands.MessageKeys;
import dev.redicloud.commands.VelocityCommandManager;
...
public class VelocityCloudCommandManager extends VelocityCommandManager implements ICommandManager<BaseCommand> {

    private final Map<MessageKeyProvider, String> messages;

    public VelocityCloudCommandManager(ProxyServer proxyServer, VelocityCloudPlugin plugin) {
