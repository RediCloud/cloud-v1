...
package net.suqatri.redicloud.limbo.configuration;

import net.suqatri.redicloud.limbo.server.data.BossBar;
import net.suqatri.redicloud.limbo.server.data.InfoForwarding;
import net.suqatri.redicloud.limbo.server.data.PingData;
import net.suqatri.redicloud.limbo.server.data.Title;
import org.spongepowered.configurate.ConfigurationNode;
import org.spongepowered.configurate.ConfigurationOptions;
import org.spongepowered.configurate.serialize.TypeSerializerCollection;
import org.spongepowered.configurate.yaml.YamlConfigurationLoader;
import net.suqatri.redicloud.limbo.util.Colors;
import net.suqatri.redicloud.limbo.world.Location;
...
public final class LimboConfig {
    ...
    public String getPlayerListHeader() {
        return "{\"text\":\"" + playerListHeader + "\"}";
    }

    public String getPlayerListFooter() {
        return "{\"text\":\"" + playerListFooter + "\"}";
    }
