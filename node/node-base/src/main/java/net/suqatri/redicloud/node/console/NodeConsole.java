...
public class NodeConsole implements IConsole {
    ...
    public void printCloudHeader(boolean printWarning) {
        ...
        log(new ConsoleLine("", "    §8» " + this.textColor + "Version: " + this.highlightColor + CloudAPI.getInstance().getProperties().getVersion() + "@" + CloudAPI.getInstance().getProperties().getGitHash() + " §8| " + this.textColor + "Discord: " + this.highlightColor + "https://discord.gg/g2HV52VV4G").setPrintPrefix(false).setPrintTimestamp(false));
        log(new ConsoleLine("", "     ").setPrintPrefix(false).setPrintTimestamp(false));
