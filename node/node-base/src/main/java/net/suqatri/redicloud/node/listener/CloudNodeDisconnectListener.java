        ...
        event.getCloudNodeAsync()
                .whenComplete((nodeHolder, t) -> {
                    ...
                    if (nodeHolder.getUniqueId().equals(NodeLauncher.getInstance().getNode().getUniqueId()))
                        return;
                    CloudAPI.getInstance().getConsole().info("Node %hc" + nodeHolder.getName() + " %tchas been disconnected from the cluster!");
                    ...
                    NodeLauncher.getInstance().getNodeManager().getNodesAsync()
                            ...
                            .onSuccess(nodeHolders -> {
                               ...
                               Optional<ICloudNode> optional = nodeHolders.stream().findFirst();
