...
import net.suqatri.redicloud.plugin.proxy.listener.LoginListener;
...
public class ProxyCloudAPI extends CloudDefaultAPIImpl<CloudService> {
    ...
    public ProxyCloudAPI(ProxyServer proxyServer) {
    ...
    private void initListeners() {
        ...
        proxyServer.getEventManager().register(this.proxyServer, new LoginListener());
